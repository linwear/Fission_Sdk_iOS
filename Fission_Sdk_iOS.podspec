Pod::Spec.new do |spec|
  ...
  spec.pod_target_xcconfig = { 
    'OTHER_LDFLAGS' => '-lObjC',
    'USER_HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/SDK/Fission_Sdk_iOS.xcframework/ios-arm64/Fission_Sdk_iOS.framework/Headers/*.{h,m}"',
  }

  spec.subspec 'Headers' do |spec|
    spec.source_files          = 'SDK/Fission_Sdk_iOS.xcframework/ios-arm64/Fission_Sdk_iOS.framework/Headers/*.{h,m}'
    spec.public_header_files   = 'SDK/Fission_Sdk_iOS.xcframework/ios-arm64/Fission_Sdk_iOS.framework/Headers/*.{h,m}'
  end
