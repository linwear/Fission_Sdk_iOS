...
/**
 ...
 @param support_14days_Weather          是否支持未来14天天气预报｜Whether the weather forecast for the next 14 days is supported
 
 @note  根据 FBAllConfigObject.firmwareConfig.support_14days_Weather 来标识是否支持未来14天天气预报（YES：weatherArray数组最多个数16个，NO：weatherArray数组最多个数7个）｜According to FBAllConfigObject.firmwareConfig.support_14days_Weather to identify whether the weather forecast for the next 14 days is supported (YES: the maximum number of weatherarray arrays is 16, and NO: the maximum number of weatherarray arrays is 7)
*/
- (void)fbPushWeatherMessageWithModel:(NSArray <FBWeatherModel *> *)weatherArray support:(BOOL)support_14days_Weather withBlock:(FBResultCallBackBlock _Nonnull)fbBlock;
...
*/
- (void)fbPushMobileLocationInformationWithLongitude:(float)longitude withLatitude:(float)latitude withBlock:(FBResultCallBackBlock _Nonnull)fbBlock;
...
/**
 ...
 @note 内部使用，建议使用FBBluetoothOTA类方法，传入对应OTA类型即可｜Internal use, It is recommended to use fbbluetoothota class methods and pass in the corresponding OTA type
 @see fbStartCheckingOTAWithBinFileData:withOTAType:withBlock:
*/
- (void)fbSynchronizeTheCustomDialData:(NSData * _Nonnull)fileData withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("Use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
...
/**
 ...
 @see fbStartCheckingOTAWithBinFileData:withOTAType:withBlock:
*/
- (void)fbSynchronousOnlineDialData:(NSData * _Nonnull)fileData withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("Use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
...
/**
 ...
 @see fbStartCheckingOTAWithBinFileData:withOTAType:withBlock:
*/
- (void)fbPushCustomMotionCategoryData:(NSData * _Nonnull)fileData withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("Use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
...
/**
 ...
 @see fbStartCheckingOTAWithBinFileData:withOTAType:withBlock:
*/
- (void)fbPushCustomMultipleMotionCategoryData:(NSData * _Nonnull)fileData withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("Use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
...
#pragma mark - 请求获取设备日志｜Request device logs
/**
 请求获取设备日志｜Request device logs
*/
