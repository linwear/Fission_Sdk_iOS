...
#ifndef SCOMPRESSLIB_SWIFT_H
#define SCOMPRESSLIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SCompressLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("SCompressLib", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace SCompressLib SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("SCompressLib") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void $s12SCompressLib0A5ParamVACycfC(SWIFT_INDIRECT_RESULT void * _Nonnull) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV2ids5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV2ids5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV5widths5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV5widths5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV6heights5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV6heights5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV6strides5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV6strides5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV11pixelFormats5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV11pixelFormats5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV9tileWidths5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV9tileWidths5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV9modeAlphas5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV9modeAlphas5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV7modeRgbs5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV7modeRgbs5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib0A5ParamV7cmpModes5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV7cmpModes5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_SCompressLib_void_ptr_0_8(char * _Nonnull result, struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 value) {
  memcpy(result + 0, &value._1, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib0A5ParamV10redChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_SCompressLib_void_ptr_0_8 {
  void * _Nullable _1;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_SCompressLib_void_ptr_0_8 swift_interop_passDirect_SCompressLib_void_ptr_0_8(const char * _Nonnull value) {
  struct swift_interop_passStub_SCompressLib_void_ptr_0_8 result;
  memcpy(&result._1, value + 0, 8);
  return result;
}

SWIFT_EXTERN void $s12SCompressLib0A5ParamV10redChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib0A4Rets2id5state9tileWidth7retDataySi_S2iSays5UInt8VGtF(ptrdiff_t id, ptrdiff_t state, ptrdiff_t tileWidth, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 retData) SWIFT_NOEXCEPT SWIFT_CALL; // SCompressRets(id:state:tileWidth:retData:)
SWIFT_EXTERN void $s12SCompressLib14SDecompressRet2id5state5width6height6format3red5green4blue5alphaySi_SiS3uSays5UInt8VGA3NtF(ptrdiff_t id, ptrdiff_t state, size_t width, size_t height, size_t format, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 red, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 green, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 blue, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 alpha) SWIFT_NOEXCEPT SWIFT_CALL; // SDecompressRet(id:state:width:height:format:red:green:blue:alpha:)
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsVACycfC(SWIFT_INDIRECT_RESULT void * _Nonnull) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN int32_t $s12SCompressLib15SDecompressRetsV5widths5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV5widths5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib15SDecompressRetsV6heights5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV6heights5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN int32_t $s12SCompressLib15SDecompressRetsV6formats5Int32Vvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV6formats5Int32Vvs(int32_t value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_SCompressLib_void_ptr_0_8 $s12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvs(struct swift_interop_passStub_SCompressLib_void_ptr_0_8 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s12SCompressLib10SPicZipApiVACycfC(SWIFT_INDIRECT_RESULT void * _Nonnull) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN void $s12SCompressLib10SPicZipApiV8Compress13compressParamyAA0aH0V_tF(const void * _Nonnull compressParam, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // Compress(compressParam:)
SWIFT_EXTERN void $s12SCompressLib10SPicZipApiV10Decompress2id10fileBufferys6UInt32V_Says5UInt8VGtF(uint32_t id, struct swift_interop_passStub_SCompressLib_void_ptr_0_8 fileBuffer, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // Decompress(id:fileBuffer:)
...
class SWIFT_SYMBOL("s:12SCompressLib0A5ParamV") SCompressParam;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SCompressLib::SCompressParam> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SCompressParam;

// Type metadata accessor for SCompressParam
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s12SCompressLib0A5ParamVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:12SCompressLib0A5ParamV") SCompressParam final {
public:
  SWIFT_INLINE_THUNK ~SCompressParam() noexcept {
    auto metadata = _impl::$s12SCompressLib0A5ParamVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SCompressParam(const SCompressParam &other) noexcept {
    auto metadata = _impl::$s12SCompressLib0A5ParamVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SCompressParam &operator =(const SCompressParam &other) noexcept {
    auto metadata = _impl::$s12SCompressLib0A5ParamVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SCompressParam &operator =(SCompressParam &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SCompressParam(SCompressParam &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  static SWIFT_INLINE_THUNK SCompressParam init() SWIFT_SYMBOL("s:12SCompressLib0A5ParamVACycfc");
  SWIFT_INLINE_THUNK int32_t getId() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV2ids5Int32Vvp");
  SWIFT_INLINE_THUNK void setId(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV2ids5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getWidth() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV5widths5Int32Vvp");
  SWIFT_INLINE_THUNK void setWidth(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV5widths5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getHeight() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV6heights5Int32Vvp");
  SWIFT_INLINE_THUNK void setHeight(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV6heights5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getStride() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV6strides5Int32Vvp");
  SWIFT_INLINE_THUNK void setStride(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV6strides5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getPixelFormat() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV11pixelFormats5Int32Vvp");
  SWIFT_INLINE_THUNK void setPixelFormat(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV11pixelFormats5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getTileWidth() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV9tileWidths5Int32Vvp");
  SWIFT_INLINE_THUNK void setTileWidth(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV9tileWidths5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getModeAlpha() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV9modeAlphas5Int32Vvp");
  SWIFT_INLINE_THUNK void setModeAlpha(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV9modeAlphas5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getModeRgb() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV7modeRgbs5Int32Vvp");
  SWIFT_INLINE_THUNK void setModeRgb(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV7modeRgbs5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getCmpMode() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV7cmpModes5Int32Vvp");
  SWIFT_INLINE_THUNK void setCmpMode(int32_t value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV7cmpModes5Int32Vvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getRedChannel() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV10redChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setRedChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV10redChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getGreenChannel() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setGreenChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getBlueChannel() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setBlueChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getAlphaChannel() const SWIFT_SYMBOL("s:12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setAlphaChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvp");
private:
  SWIFT_INLINE_THUNK SCompressParam(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK SCompressParam _make() noexcept {
    auto metadata = _impl::$s12SCompressLib0A5ParamVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return SCompressParam(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_SCompressParam;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s12SCompressLib0A5ParamVD;
  static inline constexpr $s12SCompressLib0A5ParamVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SCompressParam {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SCompressParam &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SCompressParam &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SCompressParam returnNewValue(T callable) {
    auto result = SCompressParam::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SCompressLib::SCompressParam> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return SCompressLib::_impl::$s12SCompressLib0A5ParamVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SCompressLib::SCompressParam> = true;
template<>
static inline const constexpr bool isOpaqueLayout<SCompressLib::SCompressParam> = true;
template<>
struct implClassFor<SCompressLib::SCompressParam> { using type = SCompressLib::_impl::_impl_SCompressParam; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_INLINE_THUNK void SCompressRets(swift::Int id, swift::Int state, swift::Int tileWidth, const swift::Array<uint8_t>& retData) noexcept SWIFT_SYMBOL("s:12SCompressLib0A4Rets2id5state9tileWidth7retDataySi_S2iSays5UInt8VGtF") {
  return _impl::$s12SCompressLib0A4Rets2id5state9tileWidth7retDataySi_S2iSays5UInt8VGtF(id, state, tileWidth, _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(retData)));
}


SWIFT_INLINE_THUNK void SDecompressRet(swift::Int id, swift::Int state, swift::UInt width, swift::UInt height, swift::UInt format, const swift::Array<uint8_t>& red, const swift::Array<uint8_t>& green, const swift::Array<uint8_t>& blue, const swift::Array<uint8_t>& alpha) noexcept SWIFT_SYMBOL("s:12SCompressLib14SDecompressRet2id5state5width6height6format3red5green4blue5alphaySi_SiS3uSays5UInt8VGA3NtF") {
  return _impl::$s12SCompressLib14SDecompressRet2id5state5width6height6format3red5green4blue5alphaySi_SiS3uSays5UInt8VGA3NtF(id, state, width, height, format, _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(red)), _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(green)), _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(blue)), _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(alpha)));
}

class SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV") SDecompressRets;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SCompressLib::SDecompressRets> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SDecompressRets;

// Type metadata accessor for SDecompressRets
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s12SCompressLib15SDecompressRetsVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV") SDecompressRets final {
public:
  SWIFT_INLINE_THUNK ~SDecompressRets() noexcept {
    auto metadata = _impl::$s12SCompressLib15SDecompressRetsVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SDecompressRets(const SDecompressRets &other) noexcept {
    auto metadata = _impl::$s12SCompressLib15SDecompressRetsVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SDecompressRets &operator =(const SDecompressRets &other) noexcept {
    auto metadata = _impl::$s12SCompressLib15SDecompressRetsVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SDecompressRets &operator =(SDecompressRets &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SDecompressRets(SDecompressRets &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  static SWIFT_INLINE_THUNK SDecompressRets init() SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsVACycfc");
  SWIFT_INLINE_THUNK int32_t getWidth() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV5widths5Int32Vvp");
  SWIFT_INLINE_THUNK void setWidth(int32_t value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV5widths5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getHeight() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV6heights5Int32Vvp");
  SWIFT_INLINE_THUNK void setHeight(int32_t value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV6heights5Int32Vvp");
  SWIFT_INLINE_THUNK int32_t getFormat() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV6formats5Int32Vvp");
  SWIFT_INLINE_THUNK void setFormat(int32_t value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV6formats5Int32Vvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getRedChannel() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setRedChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getGreenChannel() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setGreenChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getBlueChannel() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setBlueChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK swift::Array<uint8_t> getAlphaChannel() const SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvp");
  SWIFT_INLINE_THUNK void setAlphaChannel(const swift::Array<uint8_t>& value) SWIFT_SYMBOL("s:12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvp");
private:
  SWIFT_INLINE_THUNK SDecompressRets(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK SDecompressRets _make() noexcept {
    auto metadata = _impl::$s12SCompressLib15SDecompressRetsVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return SDecompressRets(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_SDecompressRets;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s12SCompressLib15SDecompressRetsVD;
  static inline constexpr $s12SCompressLib15SDecompressRetsVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SDecompressRets {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SDecompressRets &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SDecompressRets &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SDecompressRets returnNewValue(T callable) {
    auto result = SDecompressRets::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SCompressLib::SDecompressRets> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return SCompressLib::_impl::$s12SCompressLib15SDecompressRetsVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SCompressLib::SDecompressRets> = true;
template<>
static inline const constexpr bool isOpaqueLayout<SCompressLib::SDecompressRets> = true;
template<>
struct implClassFor<SCompressLib::SDecompressRets> { using type = SCompressLib::_impl::_impl_SDecompressRets; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:12SCompressLib10SPicZipApiV") SPicZipApi;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SCompressLib::SPicZipApi> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SPicZipApi;

// Type metadata accessor for SPicZipApi
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s12SCompressLib10SPicZipApiVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:12SCompressLib10SPicZipApiV") SPicZipApi final {
public:
  SWIFT_INLINE_THUNK ~SPicZipApi() noexcept {
    auto metadata = _impl::$s12SCompressLib10SPicZipApiVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SPicZipApi(const SPicZipApi &other) noexcept {
    auto metadata = _impl::$s12SCompressLib10SPicZipApiVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SPicZipApi &operator =(const SPicZipApi &other) noexcept {
    auto metadata = _impl::$s12SCompressLib10SPicZipApiVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SPicZipApi &operator =(SPicZipApi &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SPicZipApi(SPicZipApi &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  static SWIFT_INLINE_THUNK SPicZipApi init() SWIFT_SYMBOL("s:12SCompressLib10SPicZipApiVACycfc");
  SWIFT_INLINE_THUNK void Compress(const SCompressParam& compressParam) const SWIFT_SYMBOL("s:12SCompressLib10SPicZipApiV8Compress13compressParamyAA0aH0V_tF");
  SWIFT_INLINE_THUNK void Decompress(uint32_t id, const swift::Array<uint8_t>& fileBuffer) const SWIFT_SYMBOL("s:12SCompressLib10SPicZipApiV10Decompress2id10fileBufferys6UInt32V_Says5UInt8VGtF");
private:
  SWIFT_INLINE_THUNK SPicZipApi(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK SPicZipApi _make() noexcept {
    auto metadata = _impl::$s12SCompressLib10SPicZipApiVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return SPicZipApi(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_SPicZipApi;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s12SCompressLib10SPicZipApiVD;
  static inline constexpr $s12SCompressLib10SPicZipApiVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SPicZipApi {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SPicZipApi &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SPicZipApi &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SPicZipApi returnNewValue(T callable) {
    auto result = SPicZipApi::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SCompressLib::SPicZipApi> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return SCompressLib::_impl::$s12SCompressLib10SPicZipApiVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SCompressLib::SPicZipApi> = true;
template<>
static inline const constexpr bool isOpaqueLayout<SCompressLib::SPicZipApi> = true;
template<>
struct implClassFor<SCompressLib::SPicZipApi> { using type = SCompressLib::_impl::_impl_SPicZipApi; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace SCompressLib SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("SCompressLib") {
  ...
  SWIFT_INLINE_THUNK SCompressParam SCompressParam::init() {
  return _impl::_impl_SCompressParam::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s12SCompressLib0A5ParamVACycfC(result);
  });
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getId() const {
  return _impl::$s12SCompressLib0A5ParamV2ids5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setId(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV2ids5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getWidth() const {
  return _impl::$s12SCompressLib0A5ParamV5widths5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setWidth(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV5widths5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getHeight() const {
  return _impl::$s12SCompressLib0A5ParamV6heights5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setHeight(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV6heights5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getStride() const {
  return _impl::$s12SCompressLib0A5ParamV6strides5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setStride(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV6strides5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getPixelFormat() const {
  return _impl::$s12SCompressLib0A5ParamV11pixelFormats5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setPixelFormat(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV11pixelFormats5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getTileWidth() const {
  return _impl::$s12SCompressLib0A5ParamV9tileWidths5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setTileWidth(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV9tileWidths5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getModeAlpha() const {
  return _impl::$s12SCompressLib0A5ParamV9modeAlphas5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setModeAlpha(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV9modeAlphas5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getModeRgb() const {
  return _impl::$s12SCompressLib0A5ParamV7modeRgbs5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setModeRgb(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV7modeRgbs5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SCompressParam::getCmpMode() const {
  return _impl::$s12SCompressLib0A5ParamV7cmpModes5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SCompressParam::setCmpMode(int32_t value) {
  return _impl::$s12SCompressLib0A5ParamV7cmpModes5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SCompressParam::getRedChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib0A5ParamV10redChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SCompressParam::setRedChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib0A5ParamV10redChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SCompressParam::getGreenChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SCompressParam::setGreenChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib0A5ParamV12greenChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SCompressParam::getBlueChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SCompressParam::setBlueChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib0A5ParamV11blueChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SCompressParam::getAlphaChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SCompressParam::setAlphaChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib0A5ParamV12alphaChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK SDecompressRets SDecompressRets::init() {
  return _impl::_impl_SDecompressRets::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s12SCompressLib15SDecompressRetsVACycfC(result);
  });
  }
  SWIFT_INLINE_THUNK int32_t SDecompressRets::getWidth() const {
  return _impl::$s12SCompressLib15SDecompressRetsV5widths5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setWidth(int32_t value) {
  return _impl::$s12SCompressLib15SDecompressRetsV5widths5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SDecompressRets::getHeight() const {
  return _impl::$s12SCompressLib15SDecompressRetsV6heights5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setHeight(int32_t value) {
  return _impl::$s12SCompressLib15SDecompressRetsV6heights5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK int32_t SDecompressRets::getFormat() const {
  return _impl::$s12SCompressLib15SDecompressRetsV6formats5Int32Vvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setFormat(int32_t value) {
  return _impl::$s12SCompressLib15SDecompressRetsV6formats5Int32Vvs(value, _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SDecompressRets::getRedChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setRedChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib15SDecompressRetsV10redChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SDecompressRets::getGreenChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setGreenChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib15SDecompressRetsV12greenChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SDecompressRets::getBlueChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setBlueChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib15SDecompressRetsV11blueChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Array<uint8_t> SDecompressRets::getAlphaChannel() const {
  return swift::_impl::_impl_Array<uint8_t>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SCompressLib_void_ptr_0_8(result, _impl::$s12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void SDecompressRets::setAlphaChannel(const swift::Array<uint8_t>& value) {
  return _impl::$s12SCompressLib15SDecompressRetsV12alphaChannelSays5UInt8VGvs(_impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK SPicZipApi SPicZipApi::init() {
  return _impl::_impl_SPicZipApi::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s12SCompressLib10SPicZipApiVACycfC(result);
  });
  }
  SWIFT_INLINE_THUNK void SPicZipApi::Compress(const SCompressParam& compressParam) const {
  return _impl::$s12SCompressLib10SPicZipApiV8Compress13compressParamyAA0aH0V_tF(_impl::_impl_SCompressParam::getOpaquePointer(compressParam), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK void SPicZipApi::Decompress(uint32_t id, const swift::Array<uint8_t>& fileBuffer) const {
  return _impl::$s12SCompressLib10SPicZipApiV10Decompress2id10fileBufferys6UInt32V_Says5UInt8VGtF(id, _impl::swift_interop_passDirect_SCompressLib_void_ptr_0_8(swift::_impl::_impl_Array<uint8_t>::getOpaquePointer(fileBuffer)), _getOpaquePointer());
  }

class PicZipEvent { } SWIFT_UNAVAILABLE_MSG("protocol 'PicZipEvent' can not yet be represented in C++");

// Unavailable in C++: Swift global function 'SetZipEvent(picEvent:)'.

} // namespace SCompressLib
