Pod::Spec.new do |spec|
  ...
  原厂瑞昱SDK，负责OTA等功能的封装｜Original Realtek SDK, responsible for packaging of OTA and other functions
                   DESC
  spec.homepage     = "https://github.com/linwear/Fission_Sdk_iOS/tree/rtklef_v#{spec.version}/RTKLEFoundation"
  spec.license      = 'MIT'
  spec.author             = { "linwear" => "2435282916@qq.com" }
  spec.social_media_url   = 'https://www.linwear.com'
  spec.platform     = :ios, '10.0'
  spec.source       = { :git => "https://github.com/linwear/Fission_Sdk_iOS.git", :tag => 'rtklef_v' + spec.version.to_s }
  ...
  spec.vendored_frameworks = 'SDK/RTKLEFoundation.xcframework'
