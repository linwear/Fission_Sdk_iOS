...
/**
 ...
 1、Realtek Tool生成的单个bin的MP格式文件｜1. MP format file of single bin generated by Realtek tool
 2、Realtek Pack Tool（Windows）打包生成的包含多个bin的打包文件｜2. Package file with multiple bin generated by Realtek pack tool (Windows)
 3、旧版本实现的纯bin文件（不推荐）｜3. Pure bin file implemented in old version (not recommended)
*/
