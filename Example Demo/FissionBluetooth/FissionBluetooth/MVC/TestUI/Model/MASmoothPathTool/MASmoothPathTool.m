...
- (NSArray<MALonLatPoint*>*)kalmanFilterPath:(NSArray<MALonLatPoint*>*)originlist intensity:(int)intensity {
    ...
    lastLoc.begin = [originlist objectAtIndex:0].begin;
...
- (NSArray<MALonLatPoint*>*)reducerVerticalThreshold:(NSArray<MALonLatPoint*>*)inPoints threshHold:(float)threshHold {
    ...
    for(int i = 0; i < inPoints.count; ++i) {
        ...
        MKMapPoint curP = MKMapPointForCoordinate(CLLocationCoordinate2DMake(cur.lat, cur.lon));
        MKMapPoint prevP = MKMapPointForCoordinate(CLLocationCoordinate2DMake(pre.lat, pre.lon));
