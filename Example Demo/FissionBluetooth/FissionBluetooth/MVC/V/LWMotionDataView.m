...
- (void)createUI {
    ...
    _sportTimeLabel = [self text:LWLocalizbleString(@"时间") textFont:FONT(15) textColor:UIColorGrayLighten];
    _calorie = [self text:@"0kcal" textFont:[NSObject themePingFangSCMediumFont:24] textColor:UIColorBlack];
    _calorieLabel = [self text:LWLocalizbleString(@"热量") textFont:FONT(15) textColor:UIColorGrayLighten];
    _avgPace = [self text:@"00'00\"/km" textFont:[NSObject themePingFangSCMediumFont:24] textColor:UIColorBlack];
    _avgPaceLabel = [self text:LWLocalizbleString(@"平均配速") textFont:FONT(15) textColor:UIColorGrayLighten];
    _heartRate = [self text:@"0bpm" textFont:[NSObject themePingFangSCMediumFont:24] textColor:UIColorBlack];
    _heartRateLabel = [self text:LWLocalizbleString(@"心率") textFont:FONT(15) textColor:UIColorGrayLighten];
    _steps = [self text:@"0" textFont:[NSObject themePingFangSCMediumFont:24] textColor:UIColorBlack];
    _stepsLabel = [self text:LWLocalizbleString(@"步数") textFont:FONT(15) textColor:UIColorGrayLighten];
