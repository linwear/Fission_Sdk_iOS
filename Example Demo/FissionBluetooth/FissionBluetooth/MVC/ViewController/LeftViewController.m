...
- (void)loadData {
    ...
    [array addObjectsFromArray:@[
        ...
        @{@"personal_ui_test_icons" : LWLocalizbleString(@"Data Visualization UI")}
    ]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if ([dict.allValues.firstObject isEqualToString:LWLocalizbleString(@"Data Visualization UI")]) {
        FBTestUIViewController *vc = FBTestUIViewController.new;
        [self cw_pushViewController:vc];
    }
}
