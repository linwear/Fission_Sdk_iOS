...
/**
 城市名称（仅当 FBAllConfigObject.firmwareConfig.supportWeatherCityName == YES 时有效）｜City name (Only valid if FBAllConfigObject.firmwareConfig.supportWeatherCityName == YES)
*/
