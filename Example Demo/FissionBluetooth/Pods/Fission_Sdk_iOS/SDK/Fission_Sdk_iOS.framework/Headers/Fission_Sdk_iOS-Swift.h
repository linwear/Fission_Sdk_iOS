...
@class CBPeripheral;
@class NSURL;
SWIFT_CLASS("_TtC15Fission_Sdk_iOS20RTKAudioStreamObject")
@interface RTKAudioStreamObject : NSObject
/// 连接设备
...
@interface RTKAudioStreamObject (SWIFT_EXTENSION(Fission_Sdk_iOS)) <RTKProfileConnectionManagerDelegate>
