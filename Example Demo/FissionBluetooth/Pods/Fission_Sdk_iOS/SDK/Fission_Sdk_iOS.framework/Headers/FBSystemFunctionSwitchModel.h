...
/**
 定时血糖采集开关｜Timed blood glucose collection switch
 */
@property (nonatomic, assign) BOOL bloodGlucose;

/**
 定时血液成分采集开关｜Timed blood component collection switch
 */
@property (nonatomic, assign) BOOL bloodComponent;

/**
 血压私人模式开关｜Blood pressure private mode switch
 */
@property (nonatomic, assign) BOOL bloodPressure_prv;

/**
 血糖私人模式开关｜Blood sugar private mode switch
 */
@property (nonatomic, assign) BOOL bloodGlucose_prv;

/**
 血液成分私人模式开关｜Blood component private mode switch
 */
@property (nonatomic, assign) BOOL bloodComponent_prv;
