...
*/
- (void)fbSynchronizeTheCustomDialData:(NSData * _Nonnull)fileData otaType:(FB_OTANOTIFICATION)otaType withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("For internal use, it is recommended to use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
...
/**
 ...
 @see fbStartCheckingOTAWithBinFileData:withOTAType:withBlock:
*/
- (void)fbSynchronousOnlineDialData:(NSData * _Nonnull)fileData otaType:(FB_OTANOTIFICATION)otaType withBlock:(FBSetOtaUpgradeManagerBlock _Nonnull)fbBlock API_DEPRECATED("For internal use, it is recommended to use (FBBluetoothOTA) fbStartCheckingOTAWithBinFileData: withOTAType: withBlock: instead", macos(2.0, 2.0), ios(2.0, 2.0), tvos(2.0, 2.0), watchos(2.0, 2.0));
