...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Fission_Sdk_iOS/SDK/RTKLEFoundation.framework"
  install_framework "${PODS_ROOT}/Fission_Sdk_iOS/SDK/RTKOTASDK.framework"
  install_framework "${PODS_ROOT}/Fission_Sdk_iOS/SDK/SCompressLib.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HJViewStyle/HJViewStyle.framework"
